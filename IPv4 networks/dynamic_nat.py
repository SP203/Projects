...
def run():
    ...
    r1.cmd('ifconfig r1-eth2 10.0.0.1/24 up')  
    ...
    r2.cmd('iptables -t nat -A POSTROUTING -o r2-eth1 -j MASQUERADE')
    r2.cmd('iptables -t nat -A POSTROUTING -o r2-eth2 -j MASQUERADE')
    r2.cmd('iptables -t nat -A PREROUTING -i r2-eth1 -j DNAT --to-destination 192.168.2.0/24')
    r2.cmd('iptables -t nat -A PREROUTING -i r2-eth2 -j DNAT --to-destination 192.168.2.0/24')
    
    r3.cmd('iptables -t nat -A POSTROUTING -o r3-eth0 -j MASQUERADE')
    r3.cmd('iptables -t nat -A POSTROUTING -o r3-eth1 -j MASQUERADE')
    r3.cmd('iptables -t nat -A POSTROUTING -o r3-eth2 -j MASQUERADE')
    r3.cmd('iptables -t nat -A PREROUTING -i r3-eth1 -j DNAT --to-destination 192.168.3.0/24')
    r3.cmd('iptables -t nat -A PREROUTING -i r3-eth2 -j DNAT --to-destination 192.168.3.0/24')
